...
const string strMessageMagic = "Bradburycoin Signed Message:\n";
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BradburycoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BradburycoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("BradburycoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("bradburycoin-miner");
    ...
    try { loop {
        ...
        printf("Running BradburycoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("BradburycoinMiner terminated\n");
        throw;
    }
}
