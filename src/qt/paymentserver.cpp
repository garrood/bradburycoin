...
const QString BITCOIN_IPC_PREFIX("bradbury:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click bradbury: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start bradbury: click-to-pay handler");
    else
...
{
    // clicking on bradbury: URLs creates FileOpen events on the Mac:
